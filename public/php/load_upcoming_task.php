...
if ($stmt->rowCount() > 0) {
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '
        <div id="upcoming-task-' . $row['tasks_id'] . '" class="p-3 my-3" style="width: 100%; height: auto; background-color: var(--div-lighter); border-radius: 20px;">
  ...
  <div class="dropdown">
    ...
    echo "<p style='color: var(--text)'>No tasks are due.</p>";
}
